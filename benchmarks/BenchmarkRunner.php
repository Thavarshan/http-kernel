...
class BenchmarkRunner
{
     ...
     */
    private function runBenchmark(BenchmarkInterface $benchmark): array
    {
     ...
     */
    private function measureMethod(BenchmarkInterface $benchmark, string $methodName): array
    {
        $iterations = 0;
        $totalTime = 0.0;
     ...
     */
    private function getBenchmarkName(BenchmarkInterface $benchmark): string
    {
